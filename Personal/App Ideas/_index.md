...
Durable workspace for app concepts, product logic, MVP notes, data models, and decision logs.
...
1. Capture the raw concept.
2. Define the customer segment and product promise.
3. Write the MVP loop.
4. Define the data model and business logic.
5. Track open questions in a decisions note.
6. Only then sketch screens or implementation tickets.
