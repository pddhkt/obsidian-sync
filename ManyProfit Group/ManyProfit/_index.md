...
> **萬利嘉** is the Hong Kong + Macau distributor that carries the [[ManyProfit Group/Imarflex/_index|Imarflex 伊瑪牌]] brand — and 7 others: **Bello, Excel, GermanHome, Fujira, HannesMüller, Sigma, Famous** (+ Others). Imarflex is one brand *under* Many Profit, not a sibling.
>
...
## Client follow-up
- [[client-asap-action-request-2026-06-23]] — sendable ASAP checklist for what the client needs to sign, provide, and confirm to keep the mid-July 2026 launch target moving.
...
- See [[ManyProfit Group/Imarflex/_index|Imarflex project home]] for the Imarflex-side build/pitch context.
