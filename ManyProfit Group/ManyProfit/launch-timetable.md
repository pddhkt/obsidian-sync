...
> 兩個網店（[[ManyProfit Group/Imarflex/_index|Imarflex 伊瑪牌]] + Many Profit 萬利嘉）+ 共用 CMS，目標 **7 月中上線（待定）**。網站同後台已經起好，7 月做嘅係**微調 + 入資料 + 設定收款 / email + 上線**。詳細收費見 [[decisions/website-engagement-pricing]]。
>
> **客戶版 landscape deck（送出用）:** `ManyProfit Group/ManyProfit/launch-timetable-deck.html` → `ManyProfit-Launch-Timetable-2026-06-17.pdf`（5 張:封面 · Gantt 時間表 · 逐週行事曆 · 客戶準備/我哋負責 · 結尾）。呢個 .md 係內容來源。
