...
1. **風扇(主力)** — ✅ **循環扇(主流)+ 手提扇(主流)+ DC 馬達 + 靜音 + oscillation** 對齊 HK 2026 baseline。座枱 / 座地 入正主流,⚠️ **水冷扇降做 niche 監察、唔做 Q2 hero**(HK 媒體 listicle 2026 完全缺席,見 Market context)。USB 迷你做引流。旺季,自家網店 campaign 已 live。
2. **抽濕機 / 除濕(次主力)** — 雨季 + 潮濕,Q2 高需求。
3. **氣炸鍋(機會位)** — 夏天「少油 / 唔開火」煮食角度,已有食譜 sample 鋪路。
4. **IH 電飯煲(always-on evergreen)** — 全年高購買 intent。⚠️ 原本主打「降糖 IH」**已 commoditised**(Toshiba + Thanko 都已採 35% sugar reduction);Imarflex 要另找具體 USP(米種 / 內膽科技 / 食療 angle)。日本工藝 + 中容量 1.5–2.2L gap(IRC-20IH / IRC-22KS)做 differentiator。

## 有冇新品 / 清貨 / 高 margin SKU?

> Hero candidate 經 6-dim rubric scoring(`references/hero-sku-rubric.md`)。每軸 1-3 分,max 18;≥ 15 = hero,11-14 = secondary,≤ 10 唔 push;任何軸 1 分 = DQ。
...
- **(具體循環扇 SKU TBD)— ⚠️ pending** — 需 client confirm SKU code(M×I unknown);Demand ✅3 已建立(scan:HK01 listicle 6 循環 + DC 馬達 + dB baseline);Diff、Content、DTC 待 SKU code 落實先 score
- **(具體手提扇 SKU TBD)— ⚠️ pending** — YOHO 14 款 listicle 缺 Imarflex,有 SERP gap,但需要 SKU code 先 score
- **❌ ICF-140R 冷風機 — DQ** — Brand safety ❌1(internal-only:LIHKG 過去 ~12 個月集中提及 reliability complaint)。Q2 主推風扇時**唔 hero 冷風機**;只可以做 long-tail PDP + 主動「2 年保養登記」hero up 應對

#### 抽濕機 / 氣炸鍋 / 滅蚊燈

- **(SKU TBD per category)— ⚠️ all pending** — client 提供具體 SKU code + margin + inventory + content readiness 先 score。Demand 已有(雨季 / 夏天 / 季節)+ Diff angle 已有(「唔開火煮食」/ 法國合作 mosquito)。Pre-engagement checklist 加返。

### SKU 角色(scoring 落地之後)

- **旗艦 / 高 margin hero(Q2):** IRC-20IH(IH category),其他 category hero 待 SKU code confirm
- **Health hero:** ❌ 本季冇 candidate pass rubric(降糖 generic DQ;等 Imarflex-specific health USP 出現)
- **入門引流 / Secondary:** IRC-22KS;USB 迷你風扇(夜燈款)— 等 SKU code
- ⚠️ 季尾清貨風扇 SKU、實際 margin 排序、庫存 → **要同 client confirm**(M×I 軸全部 ⚠️ 待升)

## 客戶最近問得最多係咩?

- 保養 / 2 年保養點登記(→ [[warranty-registration]])
- 配件 / 零件邊度買(品類多 → [[parts-finder]])
- 容量點揀(電飯煲 0.6 / 0.8 / 1.0 / 2L;氣炸鍋)
- 清潔 / 點拆洗(風扇、氣炸鍋網、內膽）
- ⚠️ 以上係 workflow 通用 FAQ + 品類推斷,**未經 GSC / site search / WhatsApp 真數據校正**。

## 有冇季節性需求?

- **5–9 月:** 風扇旺季(全季持續主力)
- **雨季 / 潮濕:** 抽濕機、防潮
- **夏天滅蚊:** 法國合作 mosquito killer lamp
- **夏天煮食:** 氣炸鍋少油 / 唔開火角度
- **提前 6–8 週鋪 backlog:** 暖風機 / 秋冬廚房電器(約 8 月起準備)

## 內容最後要導去邊?

- 風扇 / 抽濕機 PDP + collection page
- IH 電飯煲 PDP(IRC-20IH、降糖系列)
- [[warranty-registration]](保養問題)
- [[parts-finder]](配件 / 清潔零件)
- WhatsApp(高 intent 查詢 / 報價)

## 一句總結方向

Q2 以「**循環扇 + 手提扇 + 抽濕**」夏季旺季搶流量做主場,「**氣炸鍋 + IH 電飯煲(降糖已 commoditised,需 Imarflex-specific health USP)**」做 evergreen convert;內容一律導去 PDP / collection,並用 **2 年保養登記 + parts finder** 做 DTC 差異化,避免同 Fortress / HKTVmall 等零售 channel 打價格戰。
