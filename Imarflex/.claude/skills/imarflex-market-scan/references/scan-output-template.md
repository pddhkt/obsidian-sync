...
>
> 呢個 scan 嘅 output **直接 paste 入 [[yyyy-qx-focus.md]] 嘅 "Market context" 段**。下游 skill = `imarflex-business-focus`。
...
> [!important]
> `imarflex-business-focus` skill 嘅 quarterly-template.md / monthly-template.md 目前**未有** "Market context" section。本 skill 落地時要請 user 順便 update 嗰兩個 template 加 section(或本 skill 嘅 agent 喺 hand-over 時主動提)。
