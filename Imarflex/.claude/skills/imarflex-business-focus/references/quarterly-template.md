...
> 5-10 條 bullet,每條:marker + source + finding → implication。詳細 source playbook 同 cadence 喺 `imarflex-market-scan` skill。所有 source 公開,pitch stage 可以做晒。Paste 自 `business-focus/yyyy-qx-market-scan.md`(由 `imarflex-market-scout` agent 出)。
