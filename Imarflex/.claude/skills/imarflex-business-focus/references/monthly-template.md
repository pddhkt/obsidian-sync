...
> 月度只更新季初 market scan 之後嘅 delta(競品 launch、viral trend、bestseller 排名變動)。如果無新變動,寫「沿用 [[yyyy-qx-focus]] 嘅 market context」,唔需要重 paste。詳細 playbook 喺 `imarflex-market-scan` skill。
