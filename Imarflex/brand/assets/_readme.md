...
Use these folders for generated or working assets that belong to `brand/` notes. Folder names match the note that uses the assets, so it is clear where each file is referenced.

| Folder | Used by | Content |
|---|---|---|
| `content-blog-direction/` | [[../content-blog-direction]] | Blog direction hero and editorial anatomy images |
