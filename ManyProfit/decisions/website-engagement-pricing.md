...
- **Quote no.:** IMX-2026-Q02 (keeps lineage with Q01). Doc now at `Imarflex/pitch/quotation/2026-q02/Imarflex 報價單-Q02-print.html` (+ PDF) — relocated in the 2026-06 vault pitch reorg; HTML's `tokens.css` link already repointed to `../../deck/tokens.css`.
