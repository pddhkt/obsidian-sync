...
The preloaded `imarflex` skill gives the project map. The preloaded `imarflex-research/business-focus` skill gives the two-level model (quarter = thesis, month = bet placement), the evidence-marker legend, the mandatory sections, and the workflow.
...
- `.claude/skills/imarflex-research/references/quarterly-template.md` — for Q draft
- `.claude/skills/imarflex-research/references/monthly-template.md` — for monthly draft
- `.claude/skills/imarflex-research/references/pre-engagement-checklist.md` — for ⚠️ → day-1 ask mapping
- `.claude/skills/imarflex-research/references/hero-sku-rubric.md` — 6-dim hero SKU scoring,**MANDATORY** every time the SKU section is touched
