...
3. **LIHKG / Reddit / 論壇 sentiment 永遠唔得入 AEO content。** 同 `imarflex-research/business-focus` 嘅 hard rule mirror —— LIHKG 引語就算 paraphrase 都唔可以入 blog / PDP / FAQ。如果 audit 時發現 source attribution 指向 LIHKG / Reddit,**即時 reject**,寫返 issue 入 audit report。
...
| `imarflex-research/business-focus` | Focus doc 入面嘅 ⚠️ author identity / source TBD 自動入 pre-engagement checklist |
