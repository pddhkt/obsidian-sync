...
| [[Learn/Dev/Tech/Go/01 Fundamentals/00 Module Overview]] | syntax, commands, functions, control flow |
| [[Learn/Dev/Tech/Go/02 Data Structures/00 Module Overview]] | slices, maps, strings, structs, pointers |
| [[Learn/Dev/Tech/Go/03 Structs Methods Interfaces/00 Module Overview]] | methods, interfaces, composition, generics |
| [[Learn/Dev/Tech/Go/04 Errors Packages Modules/00 Module Overview]] | errors, packages, modules, context |
| [[Learn/Dev/Tech/Go/05 Testing Tooling/00 Module Overview]] | tests, table tests, benchmarks, tooling |
| [[Learn/Dev/Tech/Go/06 Concurrency/00 Module Overview]] | goroutines, channels, select, mutexes |
| [[Learn/Dev/Tech/Go/07 Web Backend Go/00 Module Overview]] | HTTP APIs for React apps |
| [[Learn/Dev/Tech/Go/08 Advanced Go/00 Module Overview]] | memory, profiling, reflection, deployment |
| [[Learn/Dev/Tech/Go/09 Mini Projects/00 Module Overview]] | applied projects |
